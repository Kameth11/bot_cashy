...
require('./handlers/commands/cobros_por_metodo');
require('./handlers/commands/deudores');
require('./handlers/commands/egresos_categoria');
require('./handlers/commands/por_profesional');
